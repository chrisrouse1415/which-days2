...
export default function CrossOffDemo() {
  ...
  return (
    ...
    >
      <div
        key={state.cycle}
        className={`card fade-in p-4 shadow-raised transition-opacity duration-1000 sm:p-5 ${
      ...
      <p className="mt-3 text-center text-xs text-stone-500">
        Friends cross off the days they can&rsquo;t make. You pick from what&rsquo;s left.
      </p>
    </div>
  )
}
